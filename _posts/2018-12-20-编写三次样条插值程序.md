---
layout:     post
title:      Fortran编写三次样条插值程序
subtitle:   调用intel MKL函数库
date:       2018-12-20
author:     蘑菇熊
...
- 若要生成可独立运行的可执行文件，选择Debug模式，上一项选择Sequential，同时Runtime Library选择Debug Multithread DLL (/libs:dll /threads /dbglibs)
